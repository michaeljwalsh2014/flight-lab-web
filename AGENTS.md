...
- Preserve the v38 Improved, v39 Knowledge, and v40 Advanced model choices. The user requested removing v37 from the selector; migrate a saved v37 selection to v38 without deleting saved user data.
