...
test("adds a conversational, evidence-aware zero-cost Flight Lab Coach", async () => {
  ...
  assert.match(coach, /v39 Knowledge/);
  assert.match(coach, /v38 Improved/);
  assert.match(coach, /v37 Classic/);
  assert.match(coach, /flight-lab-coach-model/);
  ...
  assert.match(coach, /selectedModel !== "v37"/);
  assert.match(coach, /Show more/);
  assert.match(coach, /Show less/);
