...
export default function FlightLabApp({
  ...
  function scrollToProWorkspace() {
    const workspace = document.getElementById("pro-video-workspace");
  ...
  function openProAccess() {
    ...
    if (proAccess.status === "owner") {
      if (!scrollToProWorkspace()) window.location.assign("/pro");
      return;
    }
    ...
    <main>
      ...
      <section className="pro-preview" id="pro">
        ...
        <div className="pro-features">
          ...
          <article><span>03</span><b>Built-in AI knowledge</b><p>Get instant answers for records, aviation, space, science, capitals, and more without a web lookup.</p></article>
        </div>
      </section>
