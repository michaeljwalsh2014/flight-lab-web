...
const scanSchema = {
  ...
  properties: {
    ...
    reconstructionNote: { type: "string" },
  },
  required: ["recognizable", "confidence", "observations", "uncertainties", "issues", "symmetryScore", "noseAlignment", "wingDihedral", "foldDefinition", "reconstructionNote"],
